...
@Component({
  selector: 'app-agency-map-dialog',
  templateUrl: './agency-map-dialog.component.html',
  styleUrls: ['./agency-map-dialog.component.scss']
})
export class AgencyMapDialogComponent implements OnInit {
